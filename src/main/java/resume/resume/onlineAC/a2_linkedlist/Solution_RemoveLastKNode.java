...
public class Solution_RemoveLastKNode {
     ...
     *
     */
    public resume.onlineAC.a2_linkedlist.ListNode removeNthFromEnd(resume.onlineAC.a2_linkedlist.ListNode head, int n) {
        int m = n + 1;
        int count = 1;
        resume.onlineAC.a2_linkedlist.ListNode fast = head;
