 ...
 * @date :   2018-12-26
 */
public class Solution26_Tree_Convert_Linked {
    ...
    public static void main(String[] args) {
        ...
        TreeNode temp = new Solution26_Tree_Convert_Linked().Convert(TreeNode.getTree(new int[]{4, 2, 6, 1, 3, 5, 7}));
        while (temp != null) {
...
//        TreeNode.printTreeBroad(treeNode);
        temp = new Solution26_Tree_Convert_Linked().Convert(treeNode1);
        while (temp != null) {
            System.out.print(temp.val);
            temp = temp.right;
        }
        ...
        System.out.println(new Solution26_Tree_Convert_Linked().Convert(null));
    }
}
