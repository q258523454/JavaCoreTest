 ...
 * @date :   2018-12-26
 */
public class Solution24_Tree_findPath {
...
//        TreeNode treeNode = TreeNode.getTree(new int[]{10,5,12,4,7});
        ...
        Solution24_Tree_findPath solution24TreefindPath = new Solution24_Tree_findPath();
        ArrayList<ArrayList<Integer>> res = solution24TreefindPath.FindPath(treeNode, 10);
