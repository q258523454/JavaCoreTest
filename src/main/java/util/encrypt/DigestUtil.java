...
public enum DigestUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(DigestUtil.digest(pwd, "MD5"));
        pwd = "1";
        // 自定义方法 如果想要 SHA-256 参数换成 ”SHA-256”
        System.out.println(DigestUtil.digest("123", "sha-256"));
        System.out.println(DigestUtil.digest("122222222222222222222222222", "sha-256"));
        System.out.println(DigestUtil.digest("sadas萨达萨达撒", "sha-256"));
        // 第三方工具方法
