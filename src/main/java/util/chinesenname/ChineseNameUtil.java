...
public enum ChineseNameUtil {
    ...
    public static String getName() {
        return genFirstName() + ChineseCharGenerator.genRandomLengthChineseChars(1, 2);
    }
    ...
    public static String getSpecialName() {
        return genFirstName() + ChineseCharGenerator.getOneOddChar();
    }
