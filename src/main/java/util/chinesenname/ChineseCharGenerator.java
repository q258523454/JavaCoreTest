...
public class ChineseCharGenerator {
    public static final String ODD_CHINESE_CHARS = "厷厸厹厺厼厽厾叀叁参叄叅叆叇亝収叏叐叒叓叕叚叜叝叞"
    ...
    public static String genRandomLengthChineseChars(int start, int end) {
        ...
        if (length < start) {
            str = new StringBuilder(genRandomLengthChineseChars(start, end));
        } else {
