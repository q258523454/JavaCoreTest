package javacore.stringutil;// Created by ZhangJian on 18/3/6.

import java.security.MessageDigest;
import java.security.NoSuchAlgorithmException;

public class StringMD5 {
    public static String appKey="d79724d45a54eb3742fa808cafc2604e";

    public static void main(String[] args) {
        try {
            String telephone = "13266846736";
            System.out.println(getStrMD5(appKey.concat(telephone)));
            System.out.println(stringMD5(appKey.concat(telephone)));
